      ...
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
          <div class="navbar-header">
			...
			<a href="home_admin.php"><img src="img/logocoop.png"></a>
            ...
            <ul class="nav navbar-nav navbar-left">
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown-header"> Cadastros Dinâmicos </li>
                  <li><a href="cad_mensagem.php"> Cadastrar Mensagem </a></li>
                  <li><a href="cad_sinistralidade.php"> Cadastrar Sinistralidade </a></li>
		  <li><a href="atu_link.php"> Atualizar Link </a></li>
                </ul>
              </li>
			  <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class='glyphicon glyphicon-cog' aria-hidden='true'></span> Gerenciar Acessos <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li class="dropdown-header"> Gestão de Acessos </li>
                  <li><a href="#"> Cadastrar Grupo </a></li>
                  <li><a href="cad_usuario.php"> Cadastrar Usuário </a></li>
		  <li><a href="#"> Permissão por Grupo </a></li>
                </ul>
              </li>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="atu_senha_fun.php"><span class='glyphicon glyphicon-user' aria-hidden='true'></span> Alterar Senha</a></li>
