...
$conn = OCILogon("srcadger","srcadger","info_producao");
...
if (!$conn) {
    $e = oci_error();
    echo "Erro ao conectar: " . htmlentities($e['message']);
    exit;
}
...
$sql = "select DATA, 
  ...
  from ((select data,
         ...
         where a.CDPRESTADOR = '$a1'
           ...
           and a.cdevento != 179
           and substr(TPPAGAMENTO,17,8) <> '30/12/20'
		   and a.u##referencia <> 'ANT.12F'
                   --and a.u##in_estado = 'E'
        union all
         select data,
