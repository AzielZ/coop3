			...
			<div class="col-md-4 col-md-offset-4">
				<div class="panel panel-success">
					<div class="panel-heading">
			            <h2 class="panel-title"> Comprovante INSS</h2>
					</div>
					<div class="panel-body">
						...
						<table class="table table-condensed table-hover" id="datatable">
							...
							<?php 
								$resultado = retornalinhas($_SESSION["cdfuncionario"],"9");
								if(OCIExecute($resultado)){
									...
									while(OCIFetch($resultado)){
											...
											echo "		<form method='POST' action='demonstrativo.php?a1=".BASE64_ENCODE(BASE64_ENCODE(OCIResult($resultado,6)))."&a2=2&a3=".BASE64_ENCODE(OCIResult($resultado,4))."&a4=0&a5=NwnjhGrtD=aqT' target='_blank''>";
