...
if ($a2 == '1') {
$sql = "SELECT   TO_CHAR(SYSDATE,'DD/MM/YYYY HH24:MM:SS') DATA, 
                  NRPERIODO_COMPET||' - Pagto: '||NRSEQ_PAGTO_CONTROLE||' - '|| P.TPPAGAMENTO||' - '||C.DTPAGAMENTO TPPAGAMENTO,
               ...
               if (OCIResult($stmt,30) ==  '0') {
                    ...
                    }else 
                    {
                       ...
                       if (OCIResult($stmt,7) == "304") {
                         $pdf->Cell(70, 4,"      ".OCIResult($stmt,7)."  ".OCIResult($stmt,27), 0, 0, 'L', 0, 0);
                         $pdf->Cell(17, 4,"Outras Fontes", 0, 0, 'L', 0, 0);
